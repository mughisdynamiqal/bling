                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html" style="color:#d9abac;">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="register.html" style="color:#d9abac;">Create an Account!</a>
                                    </div>
                                    {{Session('error')}}
                                </div>
                            </div>
